...
## Repositório voltado para a criação do mini-projeto da matéria de Programação Orientada a Objetos I. O projeto desenvolvido consiste em um aplicativo de filmes, com o uso de uma API.
</br>

[Link do repositório](https://github.com/FelipeSouza14/CineSpace-POO.git) | [Link da API](https://www.themoviedb.org/?language=pt-BR) 
